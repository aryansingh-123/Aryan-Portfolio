          ...
          <div className="project">
            <header>
              ...
              <div className="project-links">
                <a href="https://github.com/aryansingh-123/profile_modal" target="_blank" rel="noreferrer">
                  <img src={githubIcon} alt="Visit site" /></a>
                <a href="https://aryansingh-123.github.io/profile_modal/" target="_blank" rel="noreferrer">
                  <img src={externalLink} alt="Visit site" />
                </a> </div>
            </header>
            <div className="body">
              <h3>Profile Modal - Connect with Me</h3>
              <p> The project profile modal offers quick access to key communication platforms, including WhatsApp, LinkedIn, Instagram, GitHub, and phone calling. It streamlines connectivity for professional networking and personal interactions. </p>
            </div>
            <footer> <ul className="tech-list"> <li>HTML5</li> <li>CSS</li> <li>SQL</li> </ul> </footer>
          </div>
        </ScrollAnimation>
        ...
        <ScrollAnimation animateIn="flipInX">
          <div className="project">
            <header>
              <svg width="50" xmlns="http://www.w3.org/2000/svg" role="img" viewBox="0 0 24 24" fill="none" stroke="#23ce6b " strokeWidth="1" strokeLinecap="round" strokeLinejoin="round"><title>Folder</title> <path d="M22 19a2 2 0 0 1-2 2H4a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h5l2 3h9a2 2 0 0 1 2 2z"></path> </svg>
              <div className="project-links">
                <a href="https://github.com/aryansingh-123/Stocks-Visualizing-and-Forecasting-of-Real-Time-Data" target="_blank" rel="noreferrer">
                  <img src={githubIcon} alt="Visit site" /> </a>
                <a href="https://github.com/aryansingh-123/Stocks-Visualizing-and-Forecasting-of-Real-Time-Data" target="_blank" rel="noreferrer">
            ...
            <div className="body">
              <h3>Stocks-Visualizing-and-Forecasting-of-Real-Time-Data</h3>
              <p>
        ...
        <ScrollAnimation animateIn="flipInX">
          <div className="project">
            <header>
              ...
              <div className="project-links">
                <a href="https://github.com/aryansingh-123/GestureBridge" target="\_blank" rel="noreferrer">
            ...
            <div className="body">
              <h3>GestureBridge</h3>
              <p>
              GestureBridge is a platform that enables seamless interaction through hand gestures, bridging the gap between physical actions and digital commands. It enhances user experience by offering intuitive control over devices and applications.
              </p>
            </div>
            <footer>
              <ul className="tech-list">
        ...
        <ScrollAnimation animateIn="flipInX">
          <div className="project">
            ...
            <div className="body">
              ...
              <p>Weather intelligence refers to the use of advanced data analytics, machine learning, and predictive models to analyze and forecast weather patterns. By leveraging real-time and historical data, it provides actionable insights for industries like agriculture, transportation, energy, and retail.</p>
            </div>
            <footer>
              <ul className="tech-list">
                <li>JavaScript</li>
        ...
        <ScrollAnimation animateIn="flipInX">
          <div className="project">
            <header>
              ...
              <div className="project-links">
                <a href="https://github.com/aryansingh-123/Razorpay" target="_blank" rel="noreferrer">
                  <img src={githubIcon} alt="Visit site" />
                </a>
                <a href="https://aryansingh-123.github.io/Razorpay/" target="_blank" rel="noreferrer">
                  <img src={externalLink} alt="Visit site" />
                </a>
              </div>
            </header>
            <div className="body">
              ...
              <p>Streamline payment management with a unified dashboard, enabling both online and in-person payment collection while enhancing conversion rates and minimizing</p>
            </div>
            <footer>
              <ul className="tech-list">
                <li>HTML5</li>
        ...
        <ScrollAnimation animateIn="flipInX">
          <div className="project">
            <header>
              <svg width="50" xmlns="http://www.w3.org/2000/svg" role="img" viewBox="0 0 24 24" fill="none" stroke="#23ce6b " stroke-width="1" stroke-linecap="round" stroke-linejoin="round" ><title>Folder</title><path d="M22 19a2 2 0 0 1-2 2H4a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h5l2 3h9a2 2 0 0 1 2 2z"></path></svg>
              <div className="project-links">
                <a href="https://aryansingh-123.github.io/minor_project/#" target="_blank" rel="noreferrer">
                  <img src={externalLink} alt="Visit site" />
                </a>
              </div>
            </header>
            <div className="body">
              ...
              <p>
              The system allows users to authenticate and authorize, browse and search laptops by various categories, view detailed product information, add items to the cart, select payment and shipping options, track orders, customize laptops, and save favorite products to a wishlist.
              </p>
            </div>
            <footer>
              <ul className="tech-list">
